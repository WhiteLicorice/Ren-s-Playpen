...
//Continuously light up tiles until the progress bar is maxed (bomb explodes)
function light() {
...
//	Function that submits score with dynamic hidden form + POST request upon game over
